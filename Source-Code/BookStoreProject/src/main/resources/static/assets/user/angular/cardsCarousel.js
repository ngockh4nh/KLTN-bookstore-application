...
function createCardsCarousel(cardsData) {
    ...
    <div class="cardFooter"> <span class="cardTitle" title="hohaho.com">${card_item.title}</span>
    <div class="cardDescription"><span class="ratings">${card_item.ratings}</span></div></div></div>`;
        cards += item;
    });
