...
function setUserResponse(message) {
  const user_response = `<img class="userAvatar" src='/assets/images/logo/userAvatar.jpg'><p class="userMsg">${message} </p><div class="clearfix"></div>`;
...
function getBotResponse(text) {
  botResponse = `<img class="botAvatar" src="/assets/images/logo/sara_avatar.png"/><span class="botMsg">${text}</span><div class="clearfix"></div>`;
  return botResponse;
}
...
function setBotResponse(response) {
  ...
  setTimeout(() => {
    ...
    if (response.length < 1) {
      ...
      const fallbackMsg = "Rất tiếc! Có lỗi xảy ra. Vui lòng thử lại!!!";

      const BotResponse = `<img class="botAvatar" src="/assets/images/logo/sara_avatar.png"/><p class="botMsg">${fallbackMsg}</p><div class="clearfix"></div>`;
        ...
        if (Object.hasOwnProperty.call(response[i], "text")) {
          if (response[i].text != null) {
            ...
            if (
              ...
              if (!botResponse) {
                botResponse = `<img class="botAvatar" src="/assets/images/logo/sara_avatar.png"/><p class="botMsg">${response[i].text}</p><div class="clearfix"></div>`;
              }
            }
...
// Tránh cuộn lên trên trang web mỗi khi click
$("#restart, #clear, #close").click(function(e) {
  e.preventDefault();
});

// Đặt hàm customActionTrigger() để tự động chạy khi trang web tải xong
